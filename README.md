...
In this guide we''ll need a Kubernetes cluster for testing. Let's create one using [kind](https://kind.sigs.k8s.io/) </br>
...
```
docker run -it -e GITHUB_PERSONAL_TOKEN="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" -e GITHUB_OWNER=antonioc74 -e GITHUB_REPOSITORY=aks-terraform-2048-app github-runner
```
...
```
docker login -u antonioc74 

docker tag github-runner antonioc74/github-runner
docker push antonioc74/github-runner
